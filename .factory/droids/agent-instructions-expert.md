---
name: agent-instructions-expert
...
<!-- Source: OpenCode .opencode/agents/agent-instructions-expert.md -->
<!-- Unmapped fields: mode=subagent, temperature=0.2, permission={bash:deny,task:deny} -->
