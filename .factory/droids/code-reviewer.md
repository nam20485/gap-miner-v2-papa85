...
<!-- Source: OpenCode .opencode/agents/code-reviewer.md -->
<!-- Unmapped fields: mode=subagent, temperature=0.1, permission={edit:deny,bash:allow} -->
<!-- OpenCode write=false, edit=false → Factory Create/Edit excluded (read-only + Execute) -->
